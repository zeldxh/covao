...
<body>
	...
	<main class="d-flex">
		...
		<div class="w-50 mx-auto rounded general-shadow mt-4 mobile-target overflow-hidden">
			...
			<form id="manualForm" action="./?dir=admin&controller=Staff&action=Create&id=1" method="POST" class="px-4 pb-4">
	...
	<form id="formSendExcel" action="./?dir=admin&controller=Staff&action=CreateFromJSON&id=1" method="post" hidden>
