...
<body>
	...
	<main class="d-flex">
		...
		<div class="mt-4 w-50 mx-auto rounded general-shadow mobile-target overflow-hidden">
			...
			<form id="manualForm" action="./?dir=admin&controller=Staff&action=Create&id=2" method="POST" class="px-4 pb-4">
				...
				<button id="buttonUpdate" disabled class="btn btn-comedor" type="submit">Crear</button>
				<a id="buttonBackManual" type="button" class="btn btn-secondary" href="./?dir=admin&controller=Staff&action=BillingViews&id=main">Volver</a>
			</form>
			<form class="d-none px-4 pb-4" id="excelForm">
				...
				<button id="submitExcel" disabled type="submit" class="btn btn-comedor">Enviar</button>
				<a id="buttonBackManual" type="button" class="btn btn-secondary" href="./?dir=admin&controller=Staff&action=BillingViews&id=main">Volver</a>
			</form>
		</div>
	</main>
	...
	<form id="formSubmitExcel" action="./?dir=admin&controller=Staff&action=CreateFromJSON&id=2" method="post" hidden>
	...
	<script>
		...
		//Update text under the cloud icon
		...
		const submitExcelButton = document.getElementById('submitExcel');
		submitExcelButton.addEventListener('click', (e) => {
			...
			formSubmitExcel.firstElementChild.value = jsonToSubmit;
			formSubmitExcel.lastElementChild.click();
		});
		...
		btnTemplate.addEventListener("click", function() {
			...
			let documentPreferences = data.tabla.xlsx;
